...
const en: Dict = {
  ...
  "field.sets": "Sets",
  "field.targetReps": "Target reps",
  "field.targetWeight": "Target weight (kg)",
  "field.targetSeconds": "Target seconds",
...
const ru: Dict = {
  ...
  "field.sets": "Подходы",
  "field.targetReps": "Целевые повторения",
  "field.targetWeight": "Целевой вес (кг)",
  "field.targetSeconds": "Целевые секунды",
