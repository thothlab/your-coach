...
const en: Dict = {
  ...
  "exercise.replaceMediaFile": "Replace photo or video",
  "exercise.mediaLink": "…or a link (YouTube / image)",
  "exercise.currentMedia": "Current media",
  "exercise.hasVideo": "Video attached",
  "exercise.removeMedia": "Remove media",
  "exercise.mediaWillBeRemoved": "Media will be removed on save.",
  "exercise.preview": "Preview",
  "exercise.clearSelection": "Clear selection",
  ...
  "workouts.editTitle": "Edit workout template",
  "workouts.exerciseCount": "{n} exercises",
  "workouts.loadingExercises": "Loading exercises…",
  "workouts.items": "Items",
  "workouts.mediaHint": "📷/🎥 mark exercises that already carry a photo or video.",
...
const ru: Dict = {
  ...
  "exercise.replaceMediaFile": "Заменить фото или видео",
  "exercise.mediaLink": "…или ссылка (YouTube / картинка)",
  "exercise.currentMedia": "Текущее медиа",
  "exercise.hasVideo": "Видео прикреплено",
  "exercise.removeMedia": "Удалить медиа",
  "exercise.mediaWillBeRemoved": "Медиа будет удалено при сохранении.",
  "exercise.preview": "Превью",
  "exercise.clearSelection": "Очистить выбор",
  ...
  "workouts.editTitle": "Изменить шаблон тренировки",
  "workouts.exerciseCount": "упражнений: {n}",
  "workouts.loadingExercises": "Загрузка упражнений…",
  "workouts.items": "Пункты",
  "workouts.mediaHint": "📷/🎥 отмечают упражнения, у которых уже есть фото или видео.",
